...
print("m_{motor} (kg): " + str(9*sol['variables']['m_{motor}']))
print("m_{gen} (kg): " + str(2*sol['variables']['m_{gen}']))
print("m_{gg} (kg): " + str(2*sol['variables']['m_{gg}']))
print("m_{fan} (kg): " + str(9*sol['variables']['m_{fan}']))
print("m_{propsys} (kg): " + str(sol['variables']['m_{propsys}']))
print("Output Power (MW)")
